...
func (repo *LessonRepository) CreateLesson(lesson *model.Lesson) (*model.Lesson, error) {
...
func (repo *LessonRepository) GetLessonByID(id string) (*model.Lesson, error) {
...
func (repo *LessonRepository) DeleteLessonByID(id string) error {
	return repo.db.Delete(&model.Lesson{}, "id = ?", id).Error
}
...
func (repo *LessonRepository) UpdateStatusLessonAttendance(
	...
	lessonAttendance := model.LessonAttendance{
		UserID:      userID,
		LessonID:    lessonID,
		CourseID:    courseID,
		Status:      status,
...
func (repo *LessonRepository) GetUsersByLessonID(lessonID uuid.UUID, req dtos.GetUserAttendanceLessonReq) ([]dtos.GetUserAttendanceLessonRp, int64, error) {
	...
	query := repo.db.Model(&model.LessonAttendance{}).
