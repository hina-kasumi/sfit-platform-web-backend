...
func (cs *CourseService) GetRegisteredCourses(userID string, page, pageSize int, status *model.UserCourseStatus) (dtos.PageListResp, error) {
	offset := (page - 1) * pageSize
	var total int64
...
func (cs *CourseService) GetRegisteredUsers(courseID string, page, pageSize int, status *model.UserCourseStatus) (dtos.RegisteredUsersResponse, error) {
	offset := (page - 1) * pageSize
	var total int64
...
func (cs *CourseService) RegisterUserToCourse(userIDs []string, msvs []string, courseID string, status model.UserCourseStatus) error {
...
func (s *CourseService) GetModuleByID(moduleID string) (*model.Module, error) {
...
func (s *CourseService) GetTotalCourseOfUser(userID uuid.UUID, status model.UserCourseStatus) (int64, error) {
